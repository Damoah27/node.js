...
<head>
    ...
    <title>GLOBAL SECURITY GROUPS LLC</title>
...
<body>
  ...
  <section id="home" class="home">
      ...
      <h2>with GLOBAL SECURITY GROUPS LLC services</h2>
  ...
  <section class="counters">
    <div class="container">
        ...
        <div>
            ...
            <div class="counter" data-target="720k">0</div>
            <h3>Completed Projects</h3>
        </div>
        <div>
            <i class="fas fa-users fa-4x"></i>
            <div class="counter" data-target="480k">0</div>
            <h3>Happy Clients</h3>
        </div>
        <div>
    ...
    <div class="container">
      <div class="row">
        <div class="section-head-1 col-sm-12" style="text-align: center;">
          ...
          <p>The objective of GLOBAL SECURITY GROUPS LLC is to protect the data of our clients <br>and provide quality service with affordable price.
            </p>
        </div>
        ...
        <div class="col-lg-4 col-sm-6">
          ...
          <div class="item"> <span class="icon feature_box_col_four"><i class="fa fa-database"></i></span>
            ...
            <p>Infrastructure migration from on-site to the clouds.<br><br><br></p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_five"><i class="fa fa-upload"></i></span>
            <h6>Project-2</h6>
            <p>Building the Full Devops pipeline using the Devops methodology.<br><br><br></p>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_six"><i class="fa fa-camera"></i></span>
            <h6>Project-3</h6>
            <p>Multi-stage testing and auditing of software.<br><br><br></p>
          </div>
        </div>
      </div>
    </div>
...
<div class="communicate">
    <h3>Trust our top minds to eliminate workflow pain points,implement new tech and consolidate app portfolios.</h3>
    <p>We carry more than coding skills.</p>
      ...
      <div class="row">
          <div class="accordion-container">
              ...
              <div class="accordion">
                  <div class="accordion-header">
                      <span>+</span>
                      <h3>How do I associate with GLOBAL SECURITY GROUPS?</h3>
                  </div>
                  <div class="accordion-body">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 footer-contact" style="font-size: 1.5rem;">
                      ...
                      <p>
                          ...
                          New Jersey<br>
                          United States <br>
                          <strong>Phone:</strong> +16097695030<br>
                          <strong>Email:</strong> info@globalsecuritygroups.com<br>
                      </p>
      ...
      <div class="container">
          <div class="row align-items-center">
              <div class="col-md-6 copyright" style="color: #fff; font-size: 1.3rem;">
                  Copyright &copy; 2021 GLOBAL SECURITY GROUPS LLC. All Rights Reserved.
              </div>
          </div>
      </div>
  </div>
